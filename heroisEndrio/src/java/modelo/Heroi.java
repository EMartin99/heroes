...
@NamedQueries({
    ...
    @NamedQuery(name = "Heroi.findFilter", query = "SELECT h FROM Heroi h WHERE h.codinome like :filtro or"
            + " h.nome like :filtro or"
            + " h.descricao like :filtro or"
            + " h.categoria.nome like :filtro or"
            + " h.editora.nome like :filtro  or"
            + " h.regiao.nome like :filtro")
})
